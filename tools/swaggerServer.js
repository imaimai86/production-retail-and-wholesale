...
const specPath = path.join(__dirname, 'openapi-spec.json'); // Assumes openapi-spec.json is in the same 'tools' directory
...
try {
  ...
  console.error(`Please ensure 'tools/openapi-spec.json' exists and is valid. You might need to run 'npm run generate-spec'.`);
  process.exit(1);
}
